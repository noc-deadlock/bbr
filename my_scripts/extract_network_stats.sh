...
grep "total_initiated_swaps" m5out/stats.txt | sed 's/system.ruby.network.m_total_initiated_swaps\s*/initiated_swaps = /' >> network_stats.txt
grep "total_swaps" m5out/stats.txt | sed 's/system.ruby.network.total_swaps\s*/successful_swaps = /' >> network_stats.txt
grep "total_failed_swaps" m5out/stats.txt | sed 's/system.ruby.network.m_total_failed_swaps\s*/failed_swaps = /' >> network_stats.txt
